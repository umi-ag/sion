...
impl Contract {
    ...
    pub fn echo_base58(&self, message: String) -> String {
        let bytes = bs58::decode(message).into_vec().unwrap();
    ...
    //     VP.to_string()
    //     // let vp = gen_vp();
    //     // let vp_str = serde_json::to_string(&vp).unwrap();
    //     // vp_str
    // }
}
