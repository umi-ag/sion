...
bcs.registerStructType( "0x522fba54d6e08b32c25f3819629000ea08f8e2986bd610f56326e06549c4f695::vc::VC", {
id: `0x2::object::UID`,
created_at: `u64`,
created_by: `address`,
} )

export function isVC(type: Type): boolean { return type === "0x522fba54d6e08b32c25f3819629000ea08f8e2986bd610f56326e06549c4f695::vc::VC"; }

export interface VCFields { id: string; createdAt: bigint; createdBy: string }

export class VC { static readonly $typeName = "0x522fba54d6e08b32c25f3819629000ea08f8e2986bd610f56326e06549c4f695::vc::VC"; static readonly $numTypeParams = 0;
